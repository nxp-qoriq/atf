...
int i2c_read(unsigned char chip, int addr, int alen,
	     unsigned char *buf, int len, uintptr_t nxp_i2c_addr);
int i2c_write(unsigned char chip, int addr, int alen,
	      const unsigned char *buf, int len, uintptr_t nxp_i2c_addr);
int i2c_probe_chip(unsigned char chip, uintptr_t nxp_i2c_addr);
