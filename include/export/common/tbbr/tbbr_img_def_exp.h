...
#define DDR_FW_KEY_CERT_ID		U(40)
#define DDR_UDIMM_FW_CONTENT_CERT_ID	U(41)
#define DDR_RDIMM_FW_CONTENT_CERT_ID	U(42)

/* FUSE FIP IMAGE ID */
#define FUSE_FIP_IMAGE_ID		U(43)

#define FUSE_PROV_IMAGE_ID		U(44)

#define FUSE_UP_IMAGE_ID		U(45)
