...
#define FIRMWARE_WELCOME_STR_LS_BL2	"Welcome to LS1088 BL2 Phase\n"
#define FIRMWARE_WELCOME_STR_LS_BL31	"Welcome to LS1088 BL31 Phase\n"
...
#else
#define BL2_LIMIT		(NXP_OCRAM_ADDR + NXP_OCRAM_SIZE - CSF_HDR_SZ)
#endif
#define BL2_TEXT_LIMIT		(BL2_LIMIT - CSF_HDR_SZ)
...
/* SD block buffer */
#define NXP_SD_BLOCK_BUF_SIZE	(0x4000)
